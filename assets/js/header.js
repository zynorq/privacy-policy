document.addEventListener("DOMContentLoaded", () => {
  ...
  function renderHeader() {
    ...
    // نص زر تحميل اللعبة ورابط المتجر الخاص بك
    ...
    headerElement.innerHTML = `
      ...
      <nav class="nav desktop-nav">
          ...
          <a href="${gameLink}" target="_blank" class="download-btn-header">${downloadTxt}</a>
      </nav>
      ...
      <div class="sidebar" id="sidebar-menu">
          <nav class="sidebar-nav">
              <a href="${gameLink}" target="_blank" class="download-btn-sidebar">${downloadTxt}</a>
  ...
  function attachEvents() {
    ...
    const openMenu = () => {
      ...
      burger?.classList.add("open"); // تفعيل أنميشين علامة X للزر
    ...
    const closeMenu = () => {
      ...
      burger?.classList.remove("open"); // إغلاق علامة X وإرجاع الخطوط الثلاثة
